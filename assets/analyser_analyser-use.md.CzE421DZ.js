import{_ as a,c as n,o as i,ag as l}from"./chunks/framework.WXS6e2PS.js";const d=JSON.parse('{"title":"Ready to make XCM Locations more human friendly? 👨‍🏫","description":"","frontmatter":{},"headers":[],"relativePath":"analyser/analyser-use.md","filePath":"analyser/analyser-use.md"}'),p={name:"analyser/analyser-use.md"};function e(t,s,h,k,r,c){return i(),n("div",null,[...s[0]||(s[0]=[l(`<h1 id="ready-to-make-xcm-locations-more-human-friendly-👨‍🏫" tabindex="-1">Ready to make XCM Locations more human friendly? 👨‍🏫 <a class="header-anchor" href="#ready-to-make-xcm-locations-more-human-friendly-👨‍🏫" aria-label="Permalink to &quot;Ready to make XCM Locations more human friendly? 👨‍🏫&quot;">​</a></h1><p>This documentation provides you all steps necessary to implement core XCM Analyser functions. It also provides you with handy examples that can help you understand how to use this tool to its fullest potential.</p><h2 id="implementation" tabindex="-1">Implementation <a class="header-anchor" href="#implementation" aria-label="Permalink to &quot;Implementation&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>NOTE:</span></span>
