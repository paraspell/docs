...
- Make sure to set up `EVM or EVM-Snowbridge extension` to [enable this feature](https://paraspell.github.io/docs//xcm-sdk/send-xcm.html#ethereum-polkadot-transfer).
...
For a more detailed overview, see the v14 [pull request](https://github.com/paraspell/xcm-tools/pull/1947).
