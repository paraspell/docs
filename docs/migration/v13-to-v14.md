...
- Make sure to setup `EVM or EVM-Snowbridge extension` to [enable this feature](http://localhost:5173/docs/xcm-sdk/send-xcm.html#ethereum-polkadot-transfer).
