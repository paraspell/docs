...
See documentation: [Import Chains as Constant](https://paraspell.github.io/docs/xcm-sdk/asset-package).html#import-chains-as-constants)
...
The function previously took ecosystem names in lower case as string 'polkadot', 'kusama', and so on, it has now migrated into using new TRelaychain | TExternalChain chain types to improve the experience. Explore more about the types [here](https://paraspell.github.io/docs/xcm-sdk/asset-package.html#import-chains-as-types).
