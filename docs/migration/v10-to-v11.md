...
The function `findAsset` is not mentioned in docs because it is mainly used internally, but this function allows you to see the support of an asset for a specific chain. It was renamed to `findAssetInfo`.

## 7. Pull Request Reference
