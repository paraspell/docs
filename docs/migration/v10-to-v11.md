...
See documentation: [Import Chains as Constant](https://paraspell.github.io/docs/sdk/AssetPallet.html#import-chains-as-constant)
...
✅ **Action Required:**  
Update your imports if you plan to use these new chain constants for improved type safety and consistency.
...
| Chain division types | CHAINS_WITH_RELAYS | Available via more intuitive constants | Use new constants for imports |
