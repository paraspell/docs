export default {
    ...
    themeConfig: {
        ...
        sidebar: [
          ...
          {
            text: 'ParaSpell CLI ⌨️',
            items: [
              { text: 'Getting started', link: '/paraspell-cli/getting-started' },
              { text: 'Command mode', link: '/paraspell-cli/command-mode' },
            ]
          },
          {
            text: 'XCM analyser 🔎',
          ...
          },
          {
            ...
            items: [
              { text: 'From v13 to v14', link: '/migration/v13-to-v14' },
