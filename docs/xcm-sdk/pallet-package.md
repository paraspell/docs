...
The function returns the default XCM pallet for the selected compatible Parachain. The function uses [TChain](https://paraspell.github.io/docs/xcm-sdk/asset-package.html#import-chains-as-types) types.
```ts
...
The function returns all supported XCM pallets for the selected compatible Parachain. The function uses [TChain](https://paraspell.github.io/docs/xcm-sdk/asset-package.html#import-chains-as-types) types.
```ts
...
The function returns the index of the XCM Pallet for the selected Parachain. The function uses [TChain](https://paraspell.github.io/docs/xcm-sdk/asset-package.html#import-chains-as-types) types.
```ts
...
The following function returns all pallets for local transfers of native assets for a specific chain. The function uses [TChain](https://paraspell.github.io/docs/xcm-sdk/asset-package.html#import-chains-as-types) types.
```ts
...
The following function returns all pallets for local transfers of foreign assets for a specific chain. The function uses [TChain](https://paraspell.github.io/docs/xcm-sdk/asset-package.html#import-chains-as-types) types.
```ts
